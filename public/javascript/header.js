...
function headerchange(check)
{
	...
	else if(check==2)
	{
		...
		var img=document.getElementById('GPA-profile').src="../images/login/profile-hover.png";
	}
	else if(check==3)
	{
		var text=document.getElementById('p3').style.color="white";
		var img=document.getElementById('GPA-society').src="../images/login/society-hover.png";
	}
	else if(check==4)
	{
		var text=document.getElementById('p4').style.color="white";
		var img=document.getElementById('GPA-message').src="../images/login/message-hover.png";
	}
	else if(check==5)
	{
		var text=document.getElementById('p5').style.color="white";
		var img=document.getElementById('GPA-notification').src="../images/login/notification-hover.png";
	}
}
...
function headerorigin(check)
{
	if(check==1)
	{
		...
		var img=document.getElementById('GPA-home').src="../images/login/home.png";
	}
	else if(check==2)
	{
		var text=document.getElementById('p2').style.color="black";
		var img=document.getElementById('GPA-profile').src="../images/login/profile.png";
	}
	else if(check==3)
	{
		var text=document.getElementById('p3').style.color="black";
		var img=document.getElementById('GPA-society').src="../images/login/society.png";
	}
	else if(check==4)
	{
		var text=document.getElementById('p4').style.color="black";
		var img=document.getElementById('GPA-message').src="../images/login/message.png";
	}
	else if(check==5)
	{
		var text=document.getElementById('p5').style.color="black";
		var img=document.getElementById('GPA-notification').src="../images/login/notification.png";
	}
}
...
function changelogo(connectID)
{
  ...
  connect.style.borderTop= "8px solid #6665ee";
  connect.style.borderBottom= "8px solid #6665ee";
